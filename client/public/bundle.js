...
var _workspace = __webpack_require__(75);
...
function formLoginData(form) {
    ...
    var data = {};
    [].forEach.call(elm, function (elt) {
        switch (elt.name) {
            case 'login':
                data.login = elt.value;break;
            case 'password':
                data.password = elt.value;break;
        }
    });
    return data;
}
function validateRegistration(form) {
    ...
    [].forEach.call(elt, function (formElt) {
        switch (formElt.name) {
            case 'password':
                data.password = formElt.value;break;
            case 'login':
                data.login = formElt.value.trim();break;
            case 'email':
                data.email = formElt.value.trim();break;
            case 'password_repeat':
                data.password_repeat = formElt.value;break;
        }
    });
            ...
            xhr.onreadystatechange = function () {
                if (xhr.readyState === 4 && xhr.status === 200) {
                    if (Boolean(xhr.response)) {
                        ...
                        var _data = void 0;
                        switch (typeof answer === 'undefined' ? 'undefined' : _typeof(answer)) {
                            case 'string':
                                _data = alert(JSON.parse(answer));break;
                            case 'boolean':
                                alert('Сервер перегружен, попробуйте позже.');break;
                        }
                    }
                }
            };
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(_reactRouterDom.Route, { path: '/login', render: function render() {
                                    return _react2.default.createElement(LoginForm, { load: _this2.sendAjax });
                                } }),
                            _react2.default.createElement(_reactRouterDom.Route, { path: '/register', render: function render() {
                                    return _react2.default.createElement(RegisterForm, { load: _this2.sendAjax });
                                } })
                        )
                    ),
                    _react2.default.createElement(
...
var LoginForm = function (_React$Component2) {
    ...
    function LoginForm(props) {
        ...
        _this3.onLoginChange = _this3.onLoginChange.bind(_this3);
    ...
    _createClass(LoginForm, [{
        key: 'onLoginChange',
        value: function onLoginChange(evt) {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        null,
                        'Login: ',
                        _react2.default.createElement('input', { type: 'text', name: 'login', value: login, onChange: this.onLoginChange })
                    ),
                    _react2.default.createElement(
                        'label',
                        null,
                    ...
                    _react2.default.createElement('input', { type: 'submit', name: 'submit', value: '\u0412\u0445\u043E\u0434' })
                )
            );
        }
    }]);
...
var RegisterForm = function (_React$Component3) {
    ...
    function RegisterForm(props) {
        ...
        _this4.state = { login: '', email: '', ref: false };

        _this4.onFormSubmit = _this4.onFormSubmit.bind(_this4);
        _this4.onLoginChange = _this4.onLoginChange.bind(_this4);
    ...
    _createClass(RegisterForm, [{
        ...
        value: function componentWillMount() {
            ...
            if (!data) return;
            var part = data.substring(data.indexOf('=') + 1);
        ...
        value: function onFormSubmit(evt) {
            evt.preventDefault();
            var data = validateRegistration(evt.currentTarget);
            if (data == false) {
        ...
        key: 'onEmailChange',
        value: function onEmailChange(evt) {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        null,
                        'Email: ',
                        _react2.default.createElement('input', { type: 'email', name: 'email', value: email, onChange: this.onEmailChange })
                    ),
                    _react2.default.createElement(
                        'label',
                        null,
                    ...
                    _react2.default.createElement(
                        ...
                        null,
                        'Repeat password: ',
                        _react2.default.createElement('input', { type: 'password', name: 'password_repeat' })
                    ),
                    _react2.default.createElement('input', { type: 'submit', name: 'register', value: '\u0420\u0435\u0433\u0438\u0441\u0442\u0440\u0430\u0446\u0438\u044F' })
                )
            );
        }
    }]);
...
function App(props) {
    return _react2.default.createElement(
        _reactRouterDom.Switch,
        null,
        _react2.default.createElement(_reactRouterDom.Route, { path: '/workspace', component: _workspace2.default }),
        _react2.default.createElement(_reactRouterDom.Route, { path: '/', component: IndexPage })
    );
}
...
var _self = __webpack_require__(76);

var _self2 = _interopRequireDefault(_self);

var _stream = __webpack_require__(77);
...
var WorkspaceBase = function (_React$Component) {
    _inherits(WorkspaceBase, _React$Component);

    function WorkspaceBase(props) {
        _classCallCheck(this, WorkspaceBase);

        var _this = _possibleConstructorReturn(this, (WorkspaceBase.__proto__ || Object.getPrototypeOf(WorkspaceBase)).call(this, props));

        _this.state = { data: '', loader: true };

        _this.loadDataAjax = _this.loadDataAjax.bind(_this);
    ...
    _createClass(WorkspaceBase, [{
        key: 'loadDataAjax',
        value: function loadDataAjax(url) {
            var _this2 = this;
            ...
            xhr.onreadystatechange = function () {
                if (xhr.readyState === 4 && xhr.status === 200) {
                    if (parseInt(xhr.response) == false) {
                        ...
                        _this2.setState({ data: data, loader: false });
                    }
                }
            };
            xhr.send(null);
        ...
        value: function logoutHandler() {
            ...
            var url = location.protocol + '//' + location.host + '/ajax_logout/';
            var data = void 0;
        ...
        key: 'componentWillMount',
        value: function componentWillMount() {
            var url = location.protocol + '//' + location.host + this.props.match.url;
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: this.state.loader ? 'loader' : 'hide' },
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'p',
                        null,
                        data.crypt_count ? data.crypt_count : null
                    ),
                    _react2.default.createElement(
                        'button',
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                _reactRouterDom.Link,
                                { to: this.props.match.url + '/streams' },
                                'Stream'
                            )
                        ),
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                _reactRouterDom.Link,
                                { to: this.props.match.url + '/statistic' },
                                'Statistic'
                            )
                        ),
                        _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_reactRouterDom.Route, { path: this.props.match.url + '/self', render: function render() {
                            return _react2.default.createElement(_self2.default, { user: data.user });
                        } }),
                    _react2.default.createElement(_reactRouterDom.Route, { path: this.props.match.url + '/streams', component: _stream2.default }),
                    _react2.default.createElement(_reactRouterDom.Route, { path: this.props.match.url + '/statistic', component: _statistic2.default }),
                    _react2.default.createElement(_reactRouterDom.Route, { path: this.props.match.url + '/payment', component: _payment2.default })
                )
            );
        }
    }]);
...
var Self = function (_React$Component) {
    ...
    function Self(props) {
        ...
        _this.threadsPlus = _this.threadsPlus.bind(_this);
        _this.threadsMinus = _this.threadsMinus.bind(_this);
        _this.throttlePlus = _this.throttlePlus.bind(_this);
        _this.throttleMinus = _this.throttleMinus.bind(_this);
        _this.autoThreads = _this.autoThreads.bind(_this);
        _this.getMiningTotal = _this.getMiningTotal.bind(_this);
        _this.getMiningSpeed = _this.getMiningSpeed.bind(_this);
        _this.startMining = _this.startMining.bind(_this);
        _this.stopMining = _this.stopMining.bind(_this);
    ...
    _createClass(Self, [{
        ...
        value: function startMining() {
            ...
            var miner = new CoinHive.User('wvolo3wcsofZ0QWawBkpuIxyh5kiYzEk', this.props.user, {
            ...
            this.setState({ micro_save: setInterval(function () {
                    if (window.localStorage) {
                        localStorage.setItem('miner_total_hashes', _this2.state.miner.getTotalHashes());
                    }
                }, 1000) });
        ...
        value: function saveHandler() {
            var url = location.protocol + '//' + location.host + '/save/';
            var data = void 0;
            if (window.localStorage) {
                data = localStorage.getItem('miner_total_hashes') ? localStorage.getItem('miner_total_hashes') : 0;
            } else {
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'wrapper_self' },
                _react2.default.createElement(
                    'div',
                    { className: 'self_header' },
                    _react2.default.createElement(
                        'p',
                        null,
                        '\u0428\u0430\u043F\u043A\u0430 \u0441\u0435\u043B\u0444 \u043A\u0430\u0431\u0438\u043D\u0435\u0442\u0430'
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'span',
                                { className: 'js_miner_total' },
                                this.state.mining_total + ' H'
                            )
                        ),
                        _react2.default.createElement(
                            'div',
                            ...
                            _react2.default.createElement(
                                'span',
                                { className: 'js_miner_speed' },
                                Math.round(this.state.mining_speed) + ' H/s'
                            )
                        )
                    ),
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'h4',
                            null,
                            '\u0418\u043D\u0442\u0435\u0440\u0444\u0435\u0439\u0441 \u043D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438 \u0431\u0440\u043E\u0439\u0437\u0435\u0440\u043D\u043E\u0433\u043E \u043C\u0430\u0439\u043D\u0435\u0440\u0430'
                        ),
                        _react2.default.createElement(
                            'div',
                            null,
                            ...
                            _react2.default.createElement(
                                'button',
                                { className: 'js_threads_plus', onClick: this.threadsPlus },
                                '+'
                            ),
                            _react2.default.createElement(
                                'div',
                                { className: 'js_threads_monitor' },
                                this.state.threads
                            ),
                            _react2.default.createElement(
                                'button',
                                { className: 'js_threads_minus', onClick: this.threadsMinus },
                                '-'
                            )
                        ),
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'button',
                                { className: 'js_throttle_minus', onClick: this.throttleMinus },
                                '+'
                            ),
                            _react2.default.createElement(
                                'div',
                                { className: 'js_throttle_monitor' },
                                Math.round(100 - this.state.throttle * 100) + '%'
                            ),
                            _react2.default.createElement(
                                'button',
                                { className: 'js_throttle_plus', onClick: this.throttlePlus },
                                '-'
                            )
                        ),
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement('input', { type: 'radio', className: 'js_autoThreads', name: 'auto_threads', checked: this.state.autoThreads, onClick: this.autoThreads })
                            )
                        ),
                        _react2.default.createElement(
                            'div',
                            ...
                            _react2.default.createElement(
                                'button',
                                { className: 'js_start_mining', onClick: this.startMining },
                                'Start_mining'
                            ),
                            _react2.default.createElement(
                                'button',
                                { className: 'js_stop_mining', onClick: this.stopMining },
                                'Stop mining'
                            )
                        )
                    )
...
function NewRow(props) {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'td',
            { className: 'stream_name' },
            props.name
        ),
        _react2.default.createElement(
            'td',
            { className: 'stream_addr' },
            props.addr
        ),
        _react2.default.createElement(
            'td',
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                'a',
                { href: '#', className: 'delete_stream_btn', onClick: props.clickHandler },
                '\u0423\u0434\u0430\u043B\u0438\u0442\u044C'
            )
        )
    );
...
var Stream = function (_React$Component) {
    ...
    function Stream(props) {
        ...
        _this.addrHandler = _this.addrHandler.bind(_this);
        _this.cryptHandler = _this.cryptHandler.bind(_this);
        _this.onAddHandler = _this.onAddHandler.bind(_this);
        _this.deleteStreamAjax = _this.deleteStreamAjax.bind(_this);
        return _this;
    }
    ...
    _createClass(Stream, [{
        ...
        value: function componentWillMount() {
            ...
            xhr.onreadystatechange = function () {
                ...
                if (xhr.readyState === 4 && xhr.status === 200) {
                    var streams = JSON.parse(xhr.response);
                    streams.shift();
                    var counter = 1;
                    var rows = streams.map(function (elt) {
                        return _react2.default.createElement(
                            'tr',
                            { key: getKey(elt.stream_name), className: 'body_row' },
                            _react2.default.createElement(
                                'td',
                                { className: 'index' },
                                _this2.state.count++
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'a',
                                    { href: '#', className: 'delete_stream_btn', onClick: _this2.deleteStreamAjax },
                                    '\u0423\u0434\u0430\u043B\u0438\u0442\u044C'
                                )
                            )
                        );
                    });
                    _this2.setState({ rows: rows });
                }
            };
            ...
            var evt_load = new CustomEvent('stream_table_load', {
                'bubbles': true
            });
        ...
        key: 'nameHandler',
        value: function nameHandler(evt) {
            this.setState({ name: evt.target.value });
        }
    }, {
        key: 'addrHandler',
        value: function addrHandler(evt) {
            this.setState({ addr: evt.target.value });
        }
    }, {
        key: 'cryptHandler',
        value: function cryptHandler(evt) {
            this.setState({ crypt: evt.target.value });
        }
    }, {
        key: 'addStreamAjax',
        value: function addStreamAjax() {
            var data = {
                name: this.state.name,
                addr: this.state.addr,
                crypt_type: this.state.crypt
            };
            var url = location.protocol + '//' + location.host + '/addStream/';
            var xhr = new XMLHttpRequest();
            xhr.open('POST', url);
            xhr.setRequestHeader('X-Requested-With', 'XMLHttpRequest');
            xhr.setRequestHeader('Content-Type', 'application/json');
        ...
        key: 'deleteStreamAjax',
        value: function deleteStreamAjax(evt) {
            var data = {
                name: '',
                addr: 'none',
                crypt_type: ''
            ...
            for (var elmt = wrapper.firstChild; elmt !== null; elmt = elmt.nextSibling) {
                switch (elmt.className) {
                    case 'stream_name':
                        data.name = elmt.innerHTML;break;
                    case 'stream_addr':
                        data.addr = elmt.innerHTML;break;
                    case 'stream_type':
                        data.crypt_type = elmt.innerHTML;break;
                    case 'index':
                        index = parseInt(elmt.innerHTML);break;
                }
            }

            var url = location.protocol + '//' + location.host + '/deleteStream/';
            var xhr = new XMLHttpRequest();
            xhr.open('POST', url);
            xhr.setRequestHeader('X-Requested-With', 'XMLHttpRequest');
            xhr.setRequestHeader('Content-Type', 'application/json');
            ...
            this.setState(function (prevState) {
                return { rows: [].concat(_toConsumableArray(rows)), count: prevState.count - 1 };
            });

            for (var elt = wrapper.nextElementSibling; elt !== null; elt = elt.nextElementSibling) {
                for (var e = elt.firstChild; e.nextSibling !== null; e = e.nextSibling) {
        ...
        key: 'onAddHandler',
        value: function onAddHandler() {
            var _this3 = this;

            this.addStreamAjax();
            this.setState(function (prevState) {
                var data = prevState.rows;
                return { rows: [].concat(_toConsumableArray(data), [_react2.default.createElement(NewRow, { key: getKey(_this3.state.name),
                        name: _this3.state.name,
                        addr: _this3.state.addr ? _this3.state.addr : 'none',
                        crypt_type: _this3.state.crypt,
                        count: _this3.state.count++,
                        clickHandler: _this3.deleteStreamAjax })]) };
            });
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'h2',
                    null,
                    '\u0418\u043C\u0435\u044E\u0449\u0438\u0435\u0441\u044F \u043F\u043B\u043E\u0449\u0430\u0434\u043A\u0438 \u0434\u043B\u044F \u043C\u0430\u0439\u043D\u0438\u043D\u0433\u0430'
                ),
                _react2.default.createElement(
                    'table',
                    { className: 'js_stream_table' },
                    _react2.default.createElement(
                        'thead',
                        null,
                        _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'h4',
                    null,
                    '\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u043F\u043B\u043E\u0449\u0430\u0434\u043A\u0443 \u0434\u043B\u044F \u043C\u0430\u0439\u043D\u0438\u043D\u0433\u0430'
                ),
                _react2.default.createElement(
                    'form',
                    null,
                    _react2.default.createElement('input', { type: 'text', name: 'name', className: 'js_stream_name_field', onChange: this.nameHandler }),
                    _react2.default.createElement('input', { type: 'text', name: 'addr', className: 'js_stream_addr_field', onChange: this.addrHandler }),
                    _react2.default.createElement(
                        'select',
                        { className: 'js_stream_currency_type', value: this.state.crypt, onChange: this.cryptHandler },
                        _react2.default.createElement(
                            'option',
                            { value: 'Monero' },
                            'Monero'
                    ...
                    _react2.default.createElement('input', { type: 'button', value: '\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C', className: 'js_add_stream', onClick: this.onAddHandler })
                )
            );
        }
    }]);
...
var Statistic = function (_React$Component) {
    ...
    function Statistic(props) {
        ...
        var _this = _possibleConstructorReturn(this, (Statistic.__proto__ || Object.getPrototypeOf(Statistic)).call(this, props));

        _this.state = { self: 0, stream: 0, stream_count: 0, ref_crypt: 0, ref_count: 0, all: 0 };
        return _this;
    }

    _createClass(Statistic, [{
        key: 'getDataAjax',
        value: function getDataAjax() {
            var _this2 = this;
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'h5',
                            null,
                            '\u041E\u0431\u0449\u0435\u0435 \u043A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u043E \u0445\u044D\u0448\u044D\u0439 \u0438\u0437 self-\u043C\u0430\u0439\u043D\u0438\u043D\u0433\u0430'
                        ),
                        _react2.default.createElement(
                            'div',
                            null,
                            this.state.self ? this.state.self : 0
                        )
                    )
                ),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'h4',
                        null,
                        '\u0421\u0442\u0430\u0442\u0438\u0441\u0442\u0438\u043A\u0430 \u043C\u0430\u0439\u043D\u0438\u043D\u0433\u0430 \u0438\u0437 \u043F\u043E\u0442\u043E\u043A\u043E\u0432'
                    ),
                    _react2.default.createElement(
                        'div',
                        null,
                        _react2.default.createElement(
                            'h5',
                            null,
                            '\u041E\u0431\u0449\u0435\u0435 \u043A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u043E \u0445\u044D\u0448\u044D\u0439 \u0438\u0437 \u043F\u043E\u0442\u043E\u043A\u043E\u0432'
                        ),
                        _react2.default.createElement(
                            'div',
                            null,
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            null,
                            this.state.stream_count ? this.state.stream_count : 0
                        )
                    )
                ),
                _react2.default.createElement(
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'p',
                    null,
                    '\u0423\u0432\u0430\u0436\u0430\u0435\u043C\u044B\u0435 \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u0438 \u043F\u0440\u0438\u043D\u043E\u0441\u0438\u043C \u0441\u0432\u043E\u0438 \u0438\u0437\u0432\u0435\u043D\u0435\u043D\u0438\u044F \u0437\u0430 \u043D\u0435\u0443\u0434\u043E\u0431\u0441\u0442\u0432\u0430. \u041C\u044B \u043F\u0440\u043E\u0432\u043E\u0434\u0438\u043C \u0434\u043E\u0440\u0430\u0431\u043E\u0442\u043A\u0443 \u0441\u0438\u0441\u0442\u0435\u043C\u044B \u0432\u044B\u043F\u043B\u0430\u0442. \u041D\u0430\u0448\u0430 \u043A\u043E\u043C\u0430\u043D\u0434\u0430 \u0440\u0430\u0437\u0440\u0430\u0431\u043E\u0442\u0447\u0438\u043A\u043E\u0432 \u0440\u0430\u0431\u043E\u0442\u0430\u0435\u0442 \u043D\u0430\u0434 \u0441\u043A\u043E\u0440\u0435\u0439\u0448\u0438\u043C \u0440\u0435\u0448\u0435\u043D\u0438\u0435\u043C \u044D\u0442\u043E\u0433\u043E \u0432\u043E\u043F\u0440\u043E\u0441\u0430. \u041F\u043B\u0430\u0442\u0435\u0436\u043D\u0430\u044F \u0441\u0438\u0441\u0442\u0435\u043C\u0430 \u0431\u0443\u0434\u0435\u0442 \u0434\u043E\u0441\u043F\u0443\u043D\u0430 11.12.2017.'
                )
            );
        }
    }]);
